            ...
            <div className="bg-white w-full max-w-lg rounded-softer shadow-soft-xl overflow-hidden border border-silk-beige animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="space-y-4">
                        <div>
                            <label className="text-[10px] font-black text-charcoal uppercase tracking-widest mb-1.5 block px-1">Nombre del Beneficio</label>
                            <input
                                required
                                type="text"
                        ...
                        <div>
                            <label className="text-[10px] font-black text-charcoal uppercase tracking-widest mb-1.5 block px-1">Descripción (Opcional)</label>
                            <textarea
