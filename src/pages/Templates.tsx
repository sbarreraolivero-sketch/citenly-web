...
import { FileText, Plus, X, MessageSquare, Clock, ShieldAlert, CheckCircle2, Sparkles } from 'lucide-react'
...
export default function Templates() {
    ...
    const [newTemplate, setNewTemplate] = useState({ name: '', body: '', category: 'MARKETING' })
    ...
    const handleCreateTemplate = async () => {
        ...
        try {
            const result = await retentionService.createRemoteTemplate(clinicId, newTemplate.name, newTemplate.body)
                        ...
                        <div className="space-y-4 flex flex-col">
                            <div className="flex-1 flex flex-col">
                                ...
                                {(() => {
                                    ...
                                    // Parse to integers, get unique, and sort
                                    ...
                                    return (
                                        <div className="mt-3 p-3 bg-blue-50 rounded-xl border border-blue-100 animate-in fade-in">
                                            ...
                                            <p className="text-[11px] text-blue-700/80 mb-3">Detectamos las siguientes variables y le enviaremos a Meta los siguientes ejemplos para asegurar que aprueben tu plantilla:</p>
