...
const plans = [
    {
        ...
        price: 79,
        period: '/mes',
        description: 'Todo lo necesario para organizar tu atención y automatizar el agendamiento básico de tu centro estético.',
        highlight: false,
        icon: Sparkles,
        features: [
            'Hasta 2 usuarios',
            ...
            'Retention Engine (Solo Diagnóstico)',
    ...
    },
    {
        ...
        price: 159,
        period: '/mes',
        description: 'La solución completa para captar, retener financieramente y automatizar tu clínica o cabina.',
        highlight: true,
        icon: Zap,
        features: [
    ...
    },
    {
        id: 'prestige',
        name: 'Prestige',
        tagline: 'Top de línea para expansión',
        price: 299,
        period: '/mes',
        description: 'Infraestructura empresarial absoluta para controlar y escalar múltiples sedes y doctores.',
        highlight: false,
        icon: Crown,
        features: [
