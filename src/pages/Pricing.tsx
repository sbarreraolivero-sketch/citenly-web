...
const plans = [
    {
        ...
        price: 79,
        period: '/mes',
        description: 'Para profesionales independientes o cabinas estéticas que están empezando.',
        highlight: false,
        icon: Sparkles,
        features: [
    ...
    },
    {
        ...
        price: 159,
        period: '/mes',
        description: 'Para clínicas con flujo constante y personal administrativo.',
        highlight: true,
        icon: Zap,
        features: [
            ...
            'Upselling automático post-tratamiento',
    ...
    },
    {
        ...
        price: 299,
        period: '/mes',
        description: 'Para centros de estética de alto nivel o múltiples sucursales.',
        highlight: false,
        icon: Crown,
        features: [
