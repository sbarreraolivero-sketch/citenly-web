...
const plans = [
    {
        ...
        price: 79,
        period: '/mes',
        description: 'Recomendado para: Profesionales independientes o cabinas estéticas que están empezando.',
        highlight: false,
        icon: Sparkles,
        features: [
            'Hasta 2 usuarios',
    ...
    },
    {
        ...
        price: 159,
        period: '/mes',
        description: 'Recomendado para: Clínicas con flujo constante y personal administrativo.',
        highlight: true,
        icon: Zap,
        features: [
            'Todo lo de Essence, más:',
            'Hasta 5 usuarios (con invitaciones seguras)',
            'CRM Gestión de prospectos y pipeline de ventas',
            'Campañas de Marketing (WhatsApp masivo + Etiquetas IA)',
            'Módulo de Finanzas (Ingresos y Gastos)',
            'Gestión de Servicios con Upselling',
            'Citas ilimitadas',
            'IA Avanzada con Historial clínico',
    ...
    },
    {
        id: 'prestige',
        name: 'Prestige',
        tagline: 'Exclusividad total',
        price: 299,
        period: '/mes',
        description: 'Recomendado para: Centros de estética de alto nivel o múltiples sucursales.',
        highlight: false,
        icon: Crown,
        features: [
            ...
            'Concierge Onboarding (configuramos todo)',
