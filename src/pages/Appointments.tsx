                ...
                <div className="p-6 sm:p-8">
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">Citas</h1>
                            <p className="text-sm text-sky-100/80 font-light mt-1">Gestiona la agenda de tu clínica. Organiza consultas y automatiza recordatorios para reducir el ausentismo.</p>
                        </div>
