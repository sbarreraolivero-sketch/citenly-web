                        ...
                        <div className="p-6 sm:p-8">
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">Contactos</h1>
                                    <p className="text-sm text-sky-100/80 font-light mt-1">Gestiona tu base de datos de pacientes y prospectos. Organiza tu clínica para que la IA actúe con precisión.</p>
                                </div>
