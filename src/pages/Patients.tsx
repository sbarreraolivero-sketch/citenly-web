                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                                ...
                                <div>
                                    <div className="flex flex-wrap items-center gap-3 mb-1">
                                        <h1 className="text-2xl sm:text-3xl font-black text-[#0B0B0F] dark:text-white tracking-tight">Contactos</h1>
                                        <span className="px-2.5 py-0.5 bg-[#FF2E88]/10 text-[#FF2E88] text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-full border border-[#FF2E88]/20 whitespace-nowrap">Base de Datos</span>
                                    </div>
                    ...
                    >
                        ...
                        <div className="bg-white p-3 rounded-soft border border-silk-beige/20 flex items-center gap-2 mt-4">
                            ...
                            <p className="text-[10px] text-[#0B0B0F] italic font-medium leading-relaxed">
                                Tip: Limpiar frecuentemente los contactos sin teléfono válido mejorará la eficiencia de tus campañas.
                            </p>
                        </div>
                    </GuideBox>
