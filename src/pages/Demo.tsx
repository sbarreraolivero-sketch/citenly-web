                    ...
                    {currentQ === 0 && (
                        <div className="w-full sm:max-w-md mb-6 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5">
                            ...
                            <ul className="space-y-2.5">
                                <li className="flex gap-2.5 text-sm text-white/75 leading-snug"><span>🤖</span><span>El sistema funcionando: <strong className="text-white font-bold">cómo el asistente de IA responde, agenda, confirma y reactiva clientas por WhatsApp.</strong></span></li>
                                <li className="flex gap-2.5 text-sm text-white/75 leading-snug"><span>🎯</span><span><strong className="text-white font-bold">Cómo encajaría en tu negocio</strong>: revisamos tu caso y cómo se adaptaría a tu forma de atender.</span></li>
                                <li className="flex gap-2.5 text-sm text-white/75 leading-snug"><span>💡</span><span>El <strong className="text-white font-bold">plan que calza</strong> contigo y cómo recuperas la inversión.</span></li>
                                <li className="flex gap-2.5 text-sm text-white/75 leading-snug"><span>🛡️</span><span><strong className="text-white font-bold">Sin compromiso.</strong> Si te hace sentido, lo implementamos con garantía de 7 días.</span></li>
                            </ul>
                            <p className="text-xs text-white/40 mt-4 leading-snug">Sales entendiendo exactamente cómo funcionaría en tu negocio — agendes o no.</p>
                        </div>
                    )}
