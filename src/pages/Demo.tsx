...
const TESTIMONIALS = [
    {
        ...
        role: 'Dueña · Elizabeth Microblading',
        tag: 'MICROPIGMENTACIÓN · SANTIAGO',
        quote: 'Antes perdía una cita casi todos los días. Ahora el agente agenda sola incluso a las 3 AM y yo descanso tranquila.',
        photo: '/elizabeth.jpeg',
        gradient: 'from-[#1a0010] via-[#2d001a] to-[#0d0d1a]',
    },
    {
        name: 'Tamara Oyarzún',
        role: 'Directora · Estética Corporal Vitacura',
        tag: 'ESTÉTICA CORPORAL · VITACURA',
        quote: 'En dos semanas bajé un 70% las inasistencias. Los recordatorios automáticos son lo mejor que le pasó a mi clínica.',
        photo: null,
        gradient: 'from-[#001a1a] via-[#002626] to-[#0d0d1a]',
    },
    {
        name: 'Carolina Vásquez',
        role: 'Dueña · Centro Láser Providencia',
        tag: 'DEPILACIÓN LÁSER · PROVIDENCIA',
        quote: 'Tengo una recepcionista virtual que trabaja 24/7, no falta, no se equivoca y cuesta menos que un café diario.',
        photo: null,
