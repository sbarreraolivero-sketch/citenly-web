...
export default function AdminDashboard() {
    ...
    const handleActivate = async (clinicId: string) => {
        if (!confirm('¿Estás seguro de que quieres activar esta clínica? Esto iniciará su trial de 14 días.')) {
            return
        }
        ...
        try {
                ...
                await fetch(
                    `${supabaseUrl}/rest/v1/activation_logs`,
                    {
                        ...
                        body: JSON.stringify({
                            ...
                            notes: 'Activated via HQ Admin Panel - 14 day trial started',
                        }),
                    }
                )
            }
            ...
            alert('✅ Clínica activada exitosamente. Trial de 14 días iniciado.')
        } catch (error) {
