        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <header className="bg-white border-b border-gray-200 py-4 px-6 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-extrabold text-xl tracking-tight text-charcoal">Citenly AI</span>
                </div>
                <button
                ...
                <div className="flex-1 space-y-8">
                    <div>
                        ...
                        <p className="text-gray-600 text-lg">
                            Tu prueba gratuita de 14 días no comienza hoy. Primero, necesitamos realizar tu <b>Sesión de Activación Estratégica</b> para garantizar que Citenly genere resultados desde el día uno.
                        </p>
                    </div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">Al terminar la llamada, activaremos tu acceso y comenzarán a correr tus 14 días gratuitos.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
