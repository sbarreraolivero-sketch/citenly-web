                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <h1 className="text-3xl font-black text-[#0B0B0F] dark:text-white tracking-tight">CRM & Pipeline</h1>
                                <span className="px-2.5 py-0.5 bg-[#FF2E88]/10 text-[#FF2E88] text-[10px] font-black uppercase tracking-widest rounded-full border border-[#FF2E88]/20">Sales Funnel</span>
                            </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <button 
                            ...
                            className="bg-white/80 dark:bg-black/80 text-[#0B0B0F] dark:text-white border border-[#FF2E88]/30 px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all hover:bg-white dark:hover:bg-black flex items-center gap-2"
                        >
