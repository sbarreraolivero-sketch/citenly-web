            ...
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-soft p-8 md:p-12 border border-primary-100">
                ...
                <div className="prose prose-primary max-w-none text-gray-700">
                    ...
                    <p className="text-lg leading-relaxed mb-6">
                        En <strong>Citenly AI</strong>, valoramos su confianza y estamos comprometidos con la protección y el manejo responsable de sus datos personales. Esta Política de Privacidad describe cómo recopilamos, utilizamos y protegemos su información.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-6">
                        <li>Proveer, mantener y mejorar la plataforma Citenly y sus Agentes de IA.</li>
                    ...
                    <p className="mb-6">
                        Si tiene preguntas sobre esta Política de Privacidad o el manejo de sus datos, por favor contáctenos a: <strong>contacto@citenly.com</strong>
                    </p>
                </div>
